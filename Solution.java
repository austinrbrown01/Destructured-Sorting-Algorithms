...
public class Solution {
	...
	static int ewc = 0;
	  public static void main(String[] args) {
	    //intro
	    System.out.println("\n\nWelcome to Austin's tool for calculating activation records, array overwrties, and comparisons.");
	    boolean again = true;
	    char treeStyle = 'a';
	    while (again) {
	    ...
	    System.out.println("Please note, for decision tree questions with respect to \"a1\", \"a2\", etc, enter the values in their sorted order with respect to INDEX -- i.e  \"1\" for a1, etc.");
